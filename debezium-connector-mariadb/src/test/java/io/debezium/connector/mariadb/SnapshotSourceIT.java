...
public class SnapshotSourceIT extends AbstractConnectorTest {
    ...
    protected Configuration.Builder simpleConfig() {
        return DATABASE.defaultConfig()
                ...
                .with(MariaDBConnectorConfig.SNAPSHOT_LOCKING_MODE, MariaDBConnectorConfig.SnapshotLockingMode.MINIMAL)
    ...
    private void snapshotOfSingleDatabase(boolean useGlobalLock, boolean storeOnlyCapturedTables, boolean data) throws Exception {
        ...
        final Builder builder = simpleConfig()
                .with(MariaDBConnectorConfig.TABLE_INCLUDE_LIST, DATABASE.qualifiedTableName("customers") + "," + DATABASE.qualifiedTableName("products"))
                .with(MariaDBConnectorConfig.INCLUDE_SCHEMA_CHANGES, true);
        if (!useGlobalLock) {
            builder
                    .with(MariaDBConnectorConfig.USER, "cloud")
                    .with(MariaDBConnectorConfig.PASSWORD, "cloudpass")
                    .with(MariaDBConnectorConfig.TEST_DISABLE_GLOBAL_LOCKING, "true")
                    .with(SchemaHistory.STORE_ONLY_CAPTURED_TABLES_DDL, storeOnlyCapturedTables);
        }
        if (!data) {
            builder.with(MariaDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.SCHEMA_ONLY);
        }
    ...
    public void snapshotWithBackupLocksShouldNotWaitForReads() throws Exception {
        config = simpleConfig()
                .with(MariaDBConnectorConfig.USER, "cloud")
                .with(MariaDBConnectorConfig.PASSWORD, "cloudpass")
                .with(MariaDBConnectorConfig.SNAPSHOT_LOCKING_MODE, MariaDBConnectorConfig.SnapshotLockingMode.MINIMAL_PERCONA)
                .build();
    ...
    public void shouldCreateSnapshotSelectively() throws Exception {
        config = simpleConfig()
                .with(MariaDBConnectorConfig.DATABASE_INCLUDE_LIST, "connector_(.*)_" + DATABASE.getIdentifier())
    ...
    public void shouldSnapshotCorrectlyReadFields() throws Exception {
        config = simpleConfig()
                .with(MariaDBConnectorConfig.DATABASE_INCLUDE_LIST, "connector_read_binary_field_test_" + BINARY_FIELD_DATABASE.getIdentifier())
                .with(MariaDBConnectorConfig.TABLE_INCLUDE_LIST, BINARY_FIELD_DATABASE.qualifiedTableName("binary_field"))
                .with(MariaDBConnectorConfig.ROW_COUNT_FOR_STREAMING_RESULT_SETS, "0")
                .with(MariaDBConnectorConfig.SNAPSHOT_FETCH_SIZE, "101")
                .build();
    ...
    public void shouldCreateSnapshotOfSingleDatabaseWithSchemaChanges() throws Exception {
        config = simpleConfig().with(MariaDBConnectorConfig.INCLUDE_SCHEMA_CHANGES, true).build();
    ...
    public void shouldCreateSnapshotSchemaOnlyRecovery_exception() throws Exception {
        config = simpleConfig().with(MariaDBConnectorConfig.SNAPSHOT_MODE, MariaDBConnectorConfig.SnapshotMode.SCHEMA_ONLY_RECOVERY).build();

        // Start the connector ...
        AtomicReference<Throwable> exception = new AtomicReference<>();
        start(MariaDBConnector.class, config, (success, message, error) -> {
            exception.set(error);
        });
    ...
    public void shouldCreateSnapshotSchemaOnlyRecovery() throws Exception {
        Configuration.Builder builder = simpleConfig()
                ...
                .with(MariaDBConnectorConfig.SCHEMA_HISTORY, MemorySchemaHistory.class.getName());
        config = builder.build();
        // Start the connector ...
        start(MariaDBConnector.class, config);
        ...
        builder.with(MariaDBConnectorConfig.SNAPSHOT_MODE, MariaDBConnectorConfig.SnapshotMode.SCHEMA_ONLY_RECOVERY);
        config = builder.build();
        start(MariaDBConnector.class, config);
    ...
    public void shouldSnapshotTablesInOrderSpecifiedInTableIncludeList() throws Exception {
        config = simpleConfig()
                .with(MariaDBConnectorConfig.TABLE_INCLUDE_LIST,
    ...
    public void shouldSnapshotTablesInRowCountOrderAsc() throws Exception {
        ...
        config = simpleConfig()
                ...
                .with(MariaDBConnectorConfig.SNAPSHOT_TABLES_ORDER_BY_ROW_COUNT, SnapshotTablesRowCountOrder.ASCENDING)
                .build();
    ...
    public void shouldSnapshotTablesInRowCountOrderDesc() throws Exception {
        ...
        config = simpleConfig()
                ...
                .with(MariaDBConnectorConfig.SNAPSHOT_TABLES_ORDER_BY_ROW_COUNT, SnapshotTablesRowCountOrder.DESCENDING)
                .build();
