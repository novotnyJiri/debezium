...
public class MysqlDefaultValueIT extends AbstractConnectorTest {
    ...
    public void unsignedBigIntToBigDecimalTest() throws InterruptedException {
        config = DATABASE.defaultConfig()
                .with(MariaDBConnectorConfig.SNAPSHOT_MODE, MariaDBConnectorConfig.SnapshotMode.INITIAL)
                .with(MariaDBConnectorConfig.BIGINT_UNSIGNED_HANDLING_MODE, JdbcValueConverters.BigIntUnsignedMode.PRECISE)
                .build();
        start(MariaDBConnector.class, config);
    ...
    public void dateAndTimeTest() throws InterruptedException {
        config = DATABASE.defaultConfig()
                .with(MariaDBConnectorConfig.SNAPSHOT_MODE, MariaDBConnectorConfig.SnapshotMode.INITIAL)
                .with(MariaDBConnectorConfig.TABLE_INCLUDE_LIST, DATABASE.qualifiedTableName("DATE_TIME_TABLE"))
    ...
    public void alterDateAndTimeTest() throws Exception {
        config = DATABASE.defaultConfig()
                .with(MariaDBConnectorConfig.SNAPSHOT_MODE, MariaDBConnectorConfig.SnapshotMode.INITIAL)
                .with(MariaDBConnectorConfig.TABLE_INCLUDE_LIST, DATABASE.qualifiedTableName("ALTER_DATE_TIME"))
                .with(SchemaHistory.STORE_ONLY_CAPTURED_TABLES_DDL, true)
    ...
    public void shouldConvertDefaultBoolean2Number() throws Exception {
        config = DATABASE.defaultConfig()
                ...
                .with(MariaDBConnectorConfig.TABLE_INCLUDE_LIST, DATABASE.qualifiedTableName("DBZ_4822_DEFAULT_BOOLEAN"))
                .with(SchemaHistory.STORE_ONLY_CAPTURED_TABLES_DDL, true)
                .with(MariaDBConnectorConfig.INCLUDE_SCHEMA_CHANGES, false)
    ...
    public void shouldConvertDefaultWithCharacterSetIntroducer() throws Exception {
        config = DATABASE.defaultConfig()
                .with(MariaDBConnectorConfig.SNAPSHOT_MODE, MariaDBConnectorConfig.SnapshotMode.SCHEMA_ONLY)
                .with(MariaDBConnectorConfig.TABLE_INCLUDE_LIST, DATABASE.qualifiedTableName("DBZ_5241_DEFAULT_CS_INTRO"))
                .with(SchemaHistory.STORE_ONLY_CAPTURED_TABLES_DDL, true)
                .with(MariaDBConnectorConfig.INCLUDE_SCHEMA_CHANGES, false)
                .build();
